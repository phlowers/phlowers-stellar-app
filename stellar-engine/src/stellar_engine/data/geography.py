...
def compute_localization(inputs: dict) -> dict:
    ...
    section_array = build_section_array_dist_angles(geo_inputs.spanLength, geo_inputs.lineAngle)
...
def build_section_array_dist_angles(span_length: list, line_angle: list) -> SectionArray:
