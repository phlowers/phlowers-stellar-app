...
def get_coordinates(
    ...
    vtl_under_console = list(balance_engine.balance_model.vhl_under_console().vhl)
    ...
    result = {
        ...
        "r_under_chain": balance_engine.balance_model.vhl_under_chain().R.value().tolist(),
        "r_under_console": balance_engine.balance_model.vhl_under_console().R.value().tolist(),
