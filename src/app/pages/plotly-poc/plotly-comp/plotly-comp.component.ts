...
export class PlotlyCompComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    if (this.lineTrace()) {
      ...
      this.middleLineRangeZ.set(this.computedMiddleLineRangeZ());
    }
  }
  ...
  middleLineRangeZ = signal<number>(0);
  ...
  readonly computedMiddleLineRangeZ = computed(() => {
