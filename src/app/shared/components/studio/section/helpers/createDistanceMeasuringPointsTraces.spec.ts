...
describe('createDistanceMeasuringPointsTraces', () => {
  ...
  it('should return an empty array when distanceMeasuringPoints is undefined', () => {
    expect(createDistanceMeasuringPointsTraces(undefined, '3d', 'profile')).toEqual([]);
  });

  it('should return an empty array when distanceMeasuringPoints is empty', () => {
