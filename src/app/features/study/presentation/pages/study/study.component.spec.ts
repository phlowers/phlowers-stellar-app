        ...
        TranslocoTestingModule.forRoot({
          langs: {
            en: {
              ...
              'study.notifications.ic-updated': 'Initial Condition Updated',
              'study.notifications.section-created': 'Section Created',
              'study.notifications.section-deleted': 'Section Deleted',
              'study.notifications.section-duplicated': 'Section Duplicated',
              'study.notifications.section-updated': 'Section Updated',
              'study.tabs.ground-obstacles': 'Ground and obstacles',
              'study.tabs.measurements': 'Measurements',
              'study.tabs.saved-states': 'Saved states',
