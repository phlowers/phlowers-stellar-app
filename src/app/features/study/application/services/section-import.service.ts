  ...
  private async mapExternalSectionToSection(raw: SectionImportFile): Promise<{
    ...
    return {
      section: {
        ...
        link_code: appartenance?.LIAISON_IDR ?? undefined,
        link_name: appartenance?.LIAISON_ADR ?? undefined,
        branch_code: appartenance?.BRANCHE_IDR ?? undefined,
        ...
        cm_idr: maintenanceCenterEntry?.maintenance_center_id ?? undefined,
        cm_adr: cmDesignation ?? undefined,
        gmr_idr: regionalTeamEntry?.regional_team_id ?? undefined,
        gmr_adr: gmrDesignation ?? undefined,
        eel_idr: maintenanceTeamEntry?.maintenance_team_id ?? undefined,
        eel_adr: eelDesignation ?? undefined,
        initial_conditions: [],
