        ...
        TranslocoTestingModule.forRoot({
          langs: {
            en: {
              ...
              'common.free-positioning-label': 'Free positioning',
              'common.add-point-label': 'Add point',
              'common.select-point-label': 'Select point',
              'common.point-label': 'Point',
              'common.delete-point-aria-label': 'delete point',
              'common.point-alt-label': 'Point alt.',
              'common.meter': 'm',
              'common.ref-support-dist-label': 'Ref. support dist.',
              'common.line-axis-dist-label': 'Line axis dist.',
              'studio.obstacles-form.delete-obstacle-aria-label': 'delete obstacle',
              'common.calculate-and-save-label': 'Calculate and save',
