...
import { DEBOUNCED_UPDATE_POINT_DELAY, defaultObstacleForm } from '../components/obstaclesForm/constants';
import { ObstacleFormGroupData } from '../components/obstaclesForm/interfaces';
