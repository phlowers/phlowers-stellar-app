        ...
        TranslocoTestingModule.forRoot({
          langs: {
            en: {
              ...
              'common.ice-indicator-label': 'Ice indicator',
              'common.ice-thickness-after-support-frontier': 'Ice thickness after support frontier',
              'common.ice-thickness-before-support-frontier': 'Ice thickness before support frontier',
