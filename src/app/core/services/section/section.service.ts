...
export class SectionService {
  ...
  /**
   * Create or update a section in a study. Obstacles, floors, RRTS cut strands and loads referencing a support/span
   ...
   * obstacle, a floor, an RRTS cut strands entry or a non-zero (user-defined) span load was pruned; stale zero-weight span
