...
export class SectionService {
  ...
  /**
   * Signal containing the currently active section.
   *
   * @remarks
   * This reactive signal is used to track which section is currently
   * being viewed or edited in the application.
   */
