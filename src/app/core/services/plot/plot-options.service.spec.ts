...
describe('PlotOptionsService', () => {
  ...
  describe('getCamera', () => {
    ...
    it('should prefer the live WebGL scene camera over the _fullLayout camera', () => {
      ...
      const glCamera: Camera = { eye: { x: -1, y: 0.3, z: -1.2 }, center: { x: 0, y: 0, z: 0 }, up: { x: 0, y: 0, z: 1 } };
      const staleCamera: Camera = { eye: { x: -2.7, y: -0.3, z: -2.2 }, center: { x: 0, y: 0, z: 0 }, up: { x: 0, y: 0, z: 1 } };
