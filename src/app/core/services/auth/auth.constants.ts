 ...
 * auth-serv. A full top-level navigation to this URL triggers mod_auth_openidc:
 * if no session exists the browser is redirected to the auth-serv authorization
