...
def main():
    ...
    # canton_1 = add_obstacle(canton_1, 150, 0, 20, "toit", "obstacle_1", "Section 0")
    # canton_1 = add_obstacle(canton_1, 150, 10, 30, "toit", "obstacle_1", "Section 0")
    # canton_1 = add_obstacle(canton_1, 150, 20, 40, "toit", "obstacle_1", "Section 0")

    # canton_1 = add_obstacle(canton_1, 700, -5, 30, "arbre", "obstacle_2", "Section 1")
    # canton_1 = add_obstacle(canton_1, 700, -5, 0, "arbre", "obstacle_2", "Section 1")

    # canton_1 = add_obstacle(canton_1, 800, 0, 0, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 900, 0, -30, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 1000, 0, -90, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 1100, 0, -150, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 1200, 0, -200, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 1300, 0, -190, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 1400, 0, -90, "sol", "obstacle_2", "Section 2")
    # canton_1 = add_obstacle(canton_1, 1590, 0, 0, "sol", "obstacle_2", "Section 2")
    ...
    #                 ),
    #                 dict(
    #                     args=["scene.aspectratio", dict(x=1, y=0.00005, z= .5)],
    #                     label="Mode 2D ligne",
    #                     method="relayout"
    #                 ),
    #                 dict(
    #                     args=["scene.aspectratio", dict(x=1e-5, y=1, z= .5)],
    #                     label="Mode 2D support",
    #                     method="relayout"
    #                 ),
    #                 dict(
    #                     args=["scene.aspectratio", dict(x=1, y=0.05, z= .5)],
