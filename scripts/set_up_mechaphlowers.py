...
PYODIDE_URL = f"{NPM_registry_BASE_URL}/pyodide/-/pyodide-{PYODIDE_VERSION}.tgz"


PYODIDE_LOCK_URL = f"{PYODIDE_URL}/pyodide-lock.json"
PYODIDE_DIRECTORY_PATH = "./public/pyodide"
PYODIDE_LOCK_PATH = "./env/pyodide-lock.json"
...
if __name__ == "__main__":
    ...
    process_args = ["uvx", "pip", "download", f"mechaphlowers=={MECHAPHLOWERS_VERSION}", "-d", PYODIDE_DIRECTORY_PATH]
    if uv_index:
    ...
    # pyodide_lock_content = PYODIDE_LOCK_PATH.json() #requests.get(PYODIDE_LOCK_URL, timeout=10).json()
    ...
    # The files are already available from the extracted .tgz, no need to download them again
