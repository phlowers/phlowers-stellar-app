# Free positioning — technical design

Technical companion to the user-facing {doc}`free positioning
<../../user_guide/plot/free-positioning>` page. It documents how the free
positioning (fp) behaviour is implemented so the two documents stay in sync when
requirements change.
