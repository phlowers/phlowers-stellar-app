...
var w = ["isConstructor", "isEval", "isNative", "isToplevel"],
  ...
  ee = ["args"],
  te = ["evalOrigin"],
  x = w.concat(N, _, ee, te);
function m(e) {
  if (e)
    for (var t = 0; t < x.length; t++)
      e[x[t]] !== void 0 && this["set" + E(x[t])](e[x[t]]);
}
a(m, "StackFrame");
m.prototype = {
  getArgs: a(function () {
...
for (b = 0; b < w.length; b++)
  (m.prototype["get" + E(w[b])] = k(w[b])),
    (m.prototype["set" + E(w[b])] = (function (e) {
      return function (t) {
        this[e] = !!t;
      };
    })(w[b]));
...
for (v = 0; v < N.length; v++)
  (m.prototype["get" + E(N[v])] = k(N[v])),
    (m.prototype["set" + E(N[v])] = (function (e) {
      return function (t) {
...
for (h = 0; h < _.length; h++)
  (m.prototype["get" + E(_[h])] = k(_[h])),
    (m.prototype["set" + E(_[h])] = (function (e) {
      return function (t) {
        this[e] = String(t);
      };
    })(_[h]));
...
async function T() {
  if (
    !g ||
    ((V = (await import("node:url")).default),
    (H = await import("node:fs")),
    (L = await import("node:fs/promises")),
    (z = (await import("node:vm")).default),
  ...
  let e = H,
    ...
    s = { fs: e, crypto: t, ws: i, child_process: r };
...
a(se, "node_getBinaryResponse");
function ce(e, t) {
  let i = new URL(e, location);
  return { response: fetch(i, t ? { integrity: t } : {}) };
}
a(ce, "browser_getBinaryResponse");
var F;
g ? (F = se) : (F = ce);
async function q(e, t) {
  let { response: i, binary: r } = F(e, t);
  if (r) return r;
  let s = await i;
...
a(q, "loadBinaryFile");
var R;
if ($) R = a(async (e) => await import(e), "loadScript");
else if (j)
  R = a(async (e) => {
    try {
...
async function le(e) {
  e.startsWith("file://") && (e = e.slice(7)),
    e.includes("://")
      ...
      : await import(V.pathToFileURL(e).href);
}
a(le, "nodeLoadScript");
async function J(e) {
  if (g) {
...
function Y(e) {
  let t = e.FS,
    ...
    s = {
      ...
      syncfs: a(async (n, o, c) => {
        try {
          let l = s.getLocalSet(n),
            d = await s.getRemoteSet(n),
            u = o ? d : l,
            p = o ? l : d;
          await s.reconcile(n, u, p), c(null);
        } catch (l) {
          c(l);
        }
      }, "syncfs"),
      getLocalSet: a((n) => {
        ...
        for (; d.length; ) {
          let u = d.pop(),
            p = t.stat(u);
          t.isDir(p.mode) && d.push.apply(d, t.readdir(u).filter(c).map(l(u))),
            (o[u] = { timestamp: p.mtime, mode: p.mode });
        }
        ...
        for (let [l, d] of c)
          l !== "." &&
            (o[r.join2(n.mountpoint, l)] = {
              timestamp:
                d.kind === "file"
                  ? (await d.getFile()).lastModifiedDate
                  : new Date(),
      ...
      storeRemoteEntry: a(async (n, o, c) => {
      ...
      reconcile: a(async (n, o, c) => {
        ...
        for (let f of d) {
          ...
          if (c.type === "local") {
            let S = p.get(y),
              X = await s.loadRemoteEntry(S);
            s.storeLocalEntry(f, X);
          } else {
            let S = s.loadLocalEntry(f);
            await s.storeRemoteEntry(p, y, S);
          }
        }
        for (let f of u)
          if (c.type === "local") s.removeLocalEntry(f);
          else {
            let y = r.normalize(f.replace(n.mountpoint, "/")).substring(1);
            await s.removeRemoteEntry(p, y);
          }
      }, "reconcile"),
    };
  e.FS.filesystems.NATIVEFS_ASYNC = s;
}
a(Y, "initializeNativeFS");
var de = a(async (e) => {
  let t = [];
  async function i(s) {
    for await (let n of s.values())
      t.push(n), n.kind === "directory" && (await i(n));
  }
  a(i, "collect"), await i(e);
  let r = new Map();
  r.set(".", e);
  for (let s of t) {
    let n = (await e.resolve(s)).join("/");
    r.set(n, s);
  }
  return r;
}, "getFsHandles");
function G(e) {
  let t = {
    ...
    arguments: e.args,
    API: { config: e },
    locateFile: a((i) => e.indexURL + i, "locateFile"),
    instantiateWasm: be(e.indexURL),
  };
  return t;
}
a(G, "createSettings");
...
a(pe, "computeVersionTuple");
function ge(e) {
  let t = q(e);
  return (i) => {
    i.API.pyVersionTuple = pe(i);
    let [r, s] = i.API.pyVersionTuple;
    i.FS.mkdirTree("/lib"),
      i.FS.mkdirTree(`/lib/python${r}.${s}/site-packages`),
      i.addRunDependency("install-stdlib"),
      t
        .then((n) => {
          i.FS.writeFile(`/lib/python${r}${s}.zip`, n);
        })
        .catch((n) => {
          console.error(
...
function ye(e) {
  ...
  return (
    ...
    [ge(t), ue(e.env.HOME), fe(e.env), me(e._node_mounts), Y]
  );
}
a(ye, "getFileSystemInitializationFuncs");
function be(e) {
  if (typeof WasmOffsetConverter < "u") return;
  let { binary: t, response: i } = F(e + "pyodide.asm.wasm");
  return function (r, s) {
    return (
      (async function () {
        try {
...
async function je(e = {}) {
  ...
  let i = {
      ...
      checkAPIVersion: !0,
      BUILD_ID:
        "bc2fe3bb3909baf361f79ab424a5d8af4ec74eee9c6de2180dbdffe46d8f05ed",
    },
    r = Object.assign(i, e);
  (r.env.HOME ??= "/home/pyodide"), (r.env.PYTHONINSPECT ??= "1");
  let s = G(r),
    n = s.API;
  if (
    ...
    let u = `${r.indexURL}pyodide.asm.js`;
    await R(u);
  }
  let o;
  if (e._loadSnapshot) {
    let u = await e._loadSnapshot;
    ArrayBuffer.isView(u) ? (o = u) : (o = new Uint8Array(u)),
      (s.noInitialRun = !0),
      (s.INITIAL_MEMORY = o.length);
  }
  let c = await _createPyodideModule(s);
  if (s.exitCode !== void 0) throw new c.ExitStatus(s.exitCode);
  if (
    (e.pyproxyToStringRepr && n.setPyProxyToStringMethod(!0),
    n.version !== M && r.checkAPIVersion)
  )
    throw new Error(
      `Pyodide version does not match: '${M}' <==> '${n.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`,
    );
  c.locateFile = (u) => {
...
a(je, "loadPyodide");
export { je as loadPyodide, M as version };
